...
type CategoryLessonRepositoryInterface interface {
	ListCategoryLesson(ctx context.Context, tx *sqlx.Tx, pagination *objects.Pagination) ([]models.ListCategoryLesson, *constants.ErrorResponse)
	...
	CategoryLessonPublic(ctx context.Context, tx *sqlx.Tx) (models.ListCategoryLesson, *constants.ErrorResponse)
}
