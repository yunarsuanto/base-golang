...
var (
	...
	ErrVerifyActivation                     = Error(http.StatusForbidden, "silahkan aktifkan user anda dengan memverifikasi yang akan dikirim ke email anda.")
	ErrInactiveGoogleAccount                = Error(http.StatusForbidden, "Login gagal: akun Google Anda belum terverifikasi atau token tidak valid.")
	...
	ErrInvalidGoogleToken                   = Error(http.StatusForbidden, "Akun Google Anda Tidak Valid")
